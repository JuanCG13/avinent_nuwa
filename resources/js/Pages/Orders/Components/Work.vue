...
<template>
    <div class="w-full bg-primary-300 border border-gray-200 mb-6 p-6">
        <div class="flex justify-between">
            ...
            <div class="flex">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" class="w-6 h-6 ml-2">
        ...
        <div class="pt-6 flex">
            <div class="mt-4 gap-6 columns-2 w-2/3">
                <TextInput
                    id="idTipusArticle"
